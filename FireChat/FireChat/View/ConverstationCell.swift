...
class ConverstationCell: UITableViewCell{
    ...
    // MARK: - Properties
    var converstation: Conversation? {
        didSet{ configure() }
    }
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        profileImageView.setWidth(width: 50)
        profileImageView.setHeight(height: 50)
        ...
        timestampLabel.anchor(top: topAnchor, left: rightAnchor, paddingTop: 20, paddingRight: 12)
    ...
    func configure(){
        ...
        let viewModel = ConversationViewModel(converstation: conversation)
